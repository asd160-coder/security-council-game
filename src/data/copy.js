...
export const APP = {
  ...
  creditsOverture:
    'The overture that opens the simulation is made of twelve archival photographs, one for each line of its narration, each a work of the United States government and each credited below with its source; it closes on the three seats as the White House photographers found them in 1962, three of those frames being details cut from a wider picture, as their credits say.',
  creditsVoice:
